using TideWebsiteTesting.POM;


namespace TideWebsiteTesting.StepDefinitions
    {
    [Binding]
    public class TideStepDefinitions
    {
        SearchBox1 obj = new SearchBox1 ();
        ...
        Language4 language = new Language4();
        ...
        ShopProducts6 shopProducts = new ShopProducts6();
        ...
        OurCommitment7 ourCommitment = new OurCommitment7();
        ...
        WashClothes8 HowToWashClothes = new WashClothes8();
        ...
        Whatsnew9 whatsNew = new Whatsnew9();
        ...
        CouponReward couponsRewards = new CouponReward();
